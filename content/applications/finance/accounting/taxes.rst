...
determines whether any previous tax with :ref:`taxes/base-subsequent` will modify the sales price
that this tax is based on.

.. note::
   Taxes with :ref:`taxes/included-in-price` always behave as if this setting is enabled.
